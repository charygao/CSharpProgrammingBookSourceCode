...
namespace DrawPeachBlossom
{
    public partial class Form1 : Form
    {
        ...
        private void pictureBox1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            pbox = new PictureBox();//实例化PictureBox控件
            ...
            pbox.MouseClick += new MouseEventHandler(pbox_RightKeyClick);
            switch (flag)//判断标记
            {
                case 0:
        ...
        /// <param name="e"></param>
        private void pbox_RightKeyClick(object sender, MouseEventArgs e)
        {
