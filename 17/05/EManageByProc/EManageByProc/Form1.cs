...
namespace EManageByProc
{
    public partial class Form1 : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            //sqlcmd = new SqlCommand("insert into tb_Employee(ID,Name,Sex,Age,Tel,Address,QQ,Email) values('" + txtID.Text + "','" + txtName.Text + "','" + cboxSex.Text + "'," + Convert.ToInt32(txtAge.Text) + ",'" + txtTel.Text + "','" + txtAddress.Text + "'," + Convert.ToInt32(txtQQ.Text) + ",'" + txtEmail.Text + "')", sqlcon);
            sqlcmd.CommandType = CommandType.StoredProcedure;
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                sqlcmd.ExecuteNonQuery();
                sqlcon.Close();
                MessageBox.Show("员工信息——修改成功！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
                Form1_Load(sender, e);
            }
            catch { }
        }
        ...
        private void btnDel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                sqlcmd.ExecuteNonQuery();
                sqlcon.Close();
                MessageBox.Show("员工信息——删除成功！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
                Form1_Load(sender, e);
            }
            catch { }
        }
