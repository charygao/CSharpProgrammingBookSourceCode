...
namespace Express.Common
{
    class CommClass
    {
        ...
        //public void ToolStripComboBoxBindDataSource(ToolStripComboBox toolcbx, string strValueColumn, string strDisplayColumn, string strSql, string strTableName)
        //{
        //    toolcbx.BeginUpdate();
        //    toolcbx.DataSource = dal.GetDataTable(strSql, strTableName);
        //    toolcbx.DisplayMember = strDisplayColumn;
        //    toolcbx.ValueMember = strValueColumn;
        //    toolcbx.EndUpdate();
        //}
        /// <summary>
