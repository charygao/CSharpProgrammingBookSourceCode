...
namespace WindowsFormsApplication3
{
    public partial class Main_form : Form
    {
        ...
        #region 按钮状态图片
        Image imagenew1 = global::网络多任务下载工具.Properties.Resources.pbox_new;
        Image imagenew2 = global::网络多任务下载工具.Properties.Resources.pbox_new2;
        Image imagebegin1 = global::网络多任务下载工具.Properties.Resources.pbox_start;
        Image imagebegin2 = global::网络多任务下载工具.Properties.Resources.pbox_start2;
        Image imagepause1 = global::网络多任务下载工具.Properties.Resources.pbox_pause;
        Image imagepause2 = global::网络多任务下载工具.Properties.Resources.pbox_pause2;
        Image imagedel1 = global::网络多任务下载工具.Properties.Resources.pbox_delete;
        Image imagedel2 = global::网络多任务下载工具.Properties.Resources.pbox_delete2;
        Image imageopen1 = global::网络多任务下载工具.Properties.Resources.pbox_continue;
        Image imageopen2 = global::网络多任务下载工具.Properties.Resources.pbox_continue2;
        #endregion
        ...
        private void bt_StartLoad_Load(object sender, EventArgs e)
        {
        ...
        private void BeginDisplay()
        {
            ...
            while (true)
            {
                ...
                {
                    //将出现的异常写入日志文件
                    if (ex.Message == "未能找到文件下载服务器或下载文件，请添入正确下载地址！")
                    {
                        writelog(ex.Message);
        ...
        private void exit()
        {
            ...
            {
                DialogResult dr = MessageBox.Show("正在进行下载，确认关闭应用程序", "提示",
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (RowProcess != -1)
            {
                if (RowProcess + 1 > dl.Count)
                {
                    jc[RowProcess + dl.Count > 0 ? RowProcess - dl.Count : 0].stop = false;
                }
                else
                {
                    dl[RowProcess].stop = false;
                }
            }
